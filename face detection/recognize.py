...
classifier = cv2.CascadeClassifier(r'E:/face detection/face detection/haarcascade_frontalface.xml')

model = load_model(r"E:/face detection/face detection/final_model.h5")
